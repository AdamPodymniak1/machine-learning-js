class BaseRegressor {
    ...
    fit(points) {
        this.params = { a: 0.5, b: 0.5, c: 0.5, d: 0.5 };
        if (this.type === 'Periodic') this.params.b = 12;
        ...
        for (let i = 0; i < this.iters; i++) {
            ...
            for (let p of points) {
                ...
                if (this.type === 'Linear') { da += err * x; db += err; }
                    ...
                    da += err * (x < this.params.a ? 0 : 0); 
                    db += (x < this.params.a) ? err : 0;
                    dc += (x >= this.params.a) ? err : 0;
                }
            }
    ...
    generate() {
        ...
        for (let i = 0; i < 70; i++) {
            ...
            switch(this.type) {
                ...
                case 'Step': yNorm = xNorm < 0.5 ? 0.3 : 0.7; break;
            }
